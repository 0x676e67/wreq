...
This GitHub Actions [workflow](https://github.com/0x676e67/rquest/blob/master/.github/compilation-guide/build.yml) can be used to compile the project on **Linux**, **Windows**, and **macOS**.
