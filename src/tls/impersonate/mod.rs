...
mod impersonate_imports {
    ...
    pub use crate::{
        ...
        chrome_edge_sec_fetch1, chrome_edge_ua, chrome_http2_template, chrome_tls_template,
        conditional_headers, edge_http2_template, edge_tls_template, macos_chrome_edge_sec_ch_ua,
